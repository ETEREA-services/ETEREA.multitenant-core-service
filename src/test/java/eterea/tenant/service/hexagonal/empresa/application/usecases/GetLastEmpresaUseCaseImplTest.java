package eterea.tenant.service.hexagonal.empresa.application.usecases;

import eterea.tenant.service.tenant.hexagonal.empresa.application.usecases.GetLastEmpresaUseCaseImpl;
