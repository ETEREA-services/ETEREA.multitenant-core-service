package eterea.tenant.service.tenant.hexagonal.articulomovimiento.infrastructure.web.controller;

import eterea.tenant.service.tenant.hexagonal.articulomovimiento.application.service.ArticuloMovimientoService;
import eterea.tenant.service.tenant.hexagonal.articulomovimiento.infrastructure.web.dto.ArticuloMovimientoResponse;
import eterea.tenant.service.tenant.hexagonal.articulomovimiento.infrastructure.web.mapper.ArticuloMovimientoDtoMapper;
...
@RestController
@RequestMapping("/api/tenant/core/articuloMovimiento")
