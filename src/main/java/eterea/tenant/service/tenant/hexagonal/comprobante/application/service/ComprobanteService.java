package eterea.tenant.service.tenant.hexagonal.comprobante.application.service;

import eterea.tenant.service.tenant.hexagonal.comprobante.domain.model.Comprobante;
import eterea.tenant.service.tenant.hexagonal.comprobante.domain.ports.in.*;
import eterea.tenant.service.tenant.hexagonal.comprobante.domain.ports.in.FindAllComprobantesAsociablesUseCase;
import eterea.tenant.service.tenant.hexagonal.comprobante.domain.ports.in.FindAllComprobantesByModuloUseCase;
