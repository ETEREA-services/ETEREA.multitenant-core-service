...
COPY --from=build /app/target/eterea.multitenant-core-service.jar ./eterea.multitenant-core-service.jar
...
ENTRYPOINT ["java", "-jar", "eterea.multitenant-core-service.jar"]
